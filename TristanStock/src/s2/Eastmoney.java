...
public class Eastmoney {
	...
	public static void gen() throws Exception {
		...
		InputStreamReader isr = new InputStreamReader(new FileInputStream("stockcode.txt"), "UTF-8");
		BufferedReader br2 = new BufferedReader(isr);

		long begin = System.currentTimeMillis(); // 测试起始时间
		
		File fs2 = new File("stockInfo/mess.txt");
	...
	private static String filterContent(String temp) {
	...
	public static void testFilter(){
		...
		System.out.println(filterContent(s));
	}
}
